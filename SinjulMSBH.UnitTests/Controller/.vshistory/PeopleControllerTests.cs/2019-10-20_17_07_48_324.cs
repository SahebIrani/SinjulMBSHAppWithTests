...
namespace SinjulMSBH.UnitTests.Controller
{
    public class PeopleControllerTests
    {
        ...
        public async Task Create_ModelStateValid_CreatePersonCalledOnceAsync()
        {
            ...
            var person = new Person { Name = "Sinjul MSBH", Age = 31, AccountNumber = "345-5635789702-31" };
        ...
        {
            Person person = new Person { Name = "Sinjul MSBH", Age = 27, AccountNumber = "444-468131722-26" };

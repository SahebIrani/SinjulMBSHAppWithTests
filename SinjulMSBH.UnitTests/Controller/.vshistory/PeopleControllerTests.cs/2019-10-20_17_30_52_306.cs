...
namespace SinjulMSBH.UnitTests.Controller
{
    public class PeopleControllerTests
    {
        ...
        {
            MockPersonRepository.SetupAsync(repo => repo.GetAllAsync(CancellationToken.None))
        ...
        {
            Person ps = null;
            MockPersonRepository.SetupAsync(r => r.CreatePersonAsync(It.IsAny<Person>(), CancellationToken.None))
                .Callback<Person, CancellationToken>((p, c) => { ps = p; c = CancellationToken.None; });
